...
print("Smallest element index in the array: ",np.argmin(array))
print("Largest element index in the array: ",np.argmax(array))
print("\n")

print("Sum of the array column wise: ",np.sum(array, axis=0))
print("Sum of the array row wise: ",np.sum(array, axis=1))
